        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button
              ...
              className="w-full"
            >
              {isLoading === "github" ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : providers[0].icon}
              {providers[0].name}
            </Button>
            <Button
              variant="outline"
              ...
              className="w-full"
            >
              {isLoading === "google" ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : providers[1].icon}
