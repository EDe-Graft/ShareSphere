  ...
  return (
    <>
      ...
      >
        <div
          ref={dialogRef}
          className="fixed left-[50%] top-[50%] w-full z-50 grid max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-4 my-2 sm:my-0 sm:p-6 shadow-lg rounded-lg sm:max-w-[600px] max-h-[95vh] sm:max-h-[90vh] overflow-y-auto mx-0"
          role="dialog"
          aria-modal="true"
